                                ...
                                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                                    {
                                        card_products.length > 0 && <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button className="px-5 py-[1px] bg-blue-500 text-white rounded-sm">Apply</button>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span>Total</span>
                                                <span className="text-lg text-orange-500">$879</span>
                                            </div>
                                            <button onClick={redirect} className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg bg-orange-500 text-sm text-white uppercase">Proceed to Checkout</button>
                                        </div>
                                    }
                                </div>
                            </div>
