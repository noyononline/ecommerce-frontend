            ...
            <section className="py-16">
                <div className="w-[85%] md:w-[90%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
                    ...
                    <div className="w-full flex flex-wrap">
                        <div className={`w-3/12 md-lg:4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            <h2 className="text-3xl font-bold mb-3 text-slate-600">Category</h2>
                            <div className="py-2">
                                {
                                    categorys.map((c,i) => <div key={i} className="flex justify-start items-center gap-2 py-2">
                            ...
                            <div className="py-2 flex flex-col gap-5">
                                ...
                                renderThumb={({props})=>(
                                    <div className="w-[15px] h-[15px] rounded-full bg-blue-500" {...props}/>
                                )}
                                 />
                                 <div>
                            ...
                            <div className="pl-8 md:pl-0">
                                <div className="py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border">
                                    ...
                                    <div className="flex justify-center items-center gap-3">
                                        <select className="p-1 border outline-0 bg-transparent text-slate-600 font-semibold" name="" id="">
